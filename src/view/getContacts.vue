                ...
                <table class="table table-responsive table-condensed table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        <tr v-for="(item,key) in dataList">
                            ...
                            <td v-show="tableHeader[2].val">{{item.recvid}}</td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                var self = this;
                var resData = { 'type': "getContacts", 'dataform': JSON.stringify({'cur_page':this.curpage})};
                allAjax.Contact.getContacts.call(this, resData, function (response) {
