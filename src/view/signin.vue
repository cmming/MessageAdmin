		...
		<div class="sign-in-inner">
			...
			<form>
				<div class="form-group col-lg-12 m-bottom-md">
					...
					<input autocomplete="off" type="text" class="form-control" v-model="formData.ad_uname" placeholder="用户名"
				...
				<div class="form-group col-lg-12">
					...
					<input autocomplete="off" type="password" @keyup.enter="login" class="form-control" v-model="formData.ad_pwd" placeholder="密码">
				</div>
		...
		methods: {
			login() {
				this.$validator.validateAll().then(() => {
					...
					var resData = { 'type': "login", 'dataform': JSON.stringify(this.formData)};
					this.loadding = true;
					var self = this;
